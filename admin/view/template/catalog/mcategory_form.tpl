          ...
          <div class="tab-content">
            <div class="tab-pane active in" id="tab-general">
				<div class="form-group">
					<!--theme changes-->
					<label class="col-sm-4 control-label"><strong style="color:red">NEW! </strong>Enable/Disable Show Gallery content in Category page</label>
					<div class="col-sm-8">
					   <label class="radio-inline">
						<?php 
						if ($gallery) { ?>
						<input type="radio" name="gallery" value="1" checked="checked" />
						<?php echo $text_yes; ?>
						<?php } else { ?>
					  ...
					  <label class="radio-inline">
						<?php if (!$gallery) { ?>
						<input type="radio" name="gallery" value="0" checked="checked" />
						<?php echo $text_no; ?>
						<?php } else { ?>
