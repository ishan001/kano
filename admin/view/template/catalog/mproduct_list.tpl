              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center"><?php if ($product['image']) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $product['name']  ; ?>  <?php if($product['featured'] || !empty($product['video1']) || !empty($product['tab_title']) || !empty($product['html_slick_listing']) ) echo $featured = '<span class="label label-info">Featured</span>'; ?></td>
