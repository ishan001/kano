            ...
            <div class="tab-pane active" id="tab-general">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						...
						<a href="" id="thumb-fimage" data-toggle="image" class="img-thumbnail"><img src="<?php echo $fthumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
						<input type="hidden" name="fimage" value="<?php echo $fimage; ?>" id="input-fimage" />
					</div>

					<label class="col-sm-4 control-label"><strong style="color:red">NEW! </strong>Use featured image Gallery in Category page</label>
					<div class="col-sm-8">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
					...
					<div class="form-group">
                        <label class="col-sm-4 control-label" for="input-html_product_right<?php echo $language['language_id']; ?>">
                            ...
                            <span data-toggle="tooltip" title="<?php echo $help_html_slick_listing; ?>">
                                Promo content for  Gallery in Category page
                            </span>
                        ...
                        <div class="col-sm-8">
                            <textarea name="product_description[<?php echo $language['language_id']; ?>][html_slick_listing]" placeholder="<?php echo $entry_html_slick_listing; ?>" id="input-html_slick_listing<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['html_slick_listing'] : ''; ?></textarea>
                        </div>
                    </div>
...
$('#input-html_slick_listing<?php echo $language['language_id']; ?>').summernote({height: 300});
  <?php } ?>
//--></script> 
  <script type="text/javascript"><!--
// Manufacturer
