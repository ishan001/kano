              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <?php if ($name == 'Footer' || $name == 'footer') { ?> 
                 ...
                 <?php } else { ?>   
                    ...
                    <?php } ?>
          <?php if ($layout_module['position'] == 'content_topbar') { ?>
                    <option value="content_topbar" selected="selected">Content Topbar</option>
                    <?php } else { ?>
                    <option value="content_topbar">Content Topbar</option>
                    <?php } ?>          
...
function addModule() {
  ...
  html += '    <option value="content_topbar">Content Topbar</option>';
