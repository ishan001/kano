      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-html" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-type"><span data-toggle="tooltip" title="<?php echo $help_type; ?>"><?php echo $entry_type; ?></label>
            <div class="col-sm-10">
              <select name="type" id="input-type" class="form-control">
                <?php if ($type == "blogs") { ?>
                <option value="blogs" selected="selected"><?php echo $text_blogs; ?></option>
                <option value="tags"><?php echo $text_tags; ?></option>
                <option value="all"><?php echo $text_all; ?></option>
                <?php } elseif ($type == 'tags') { ?>
                <option value="blogs"><?php echo $text_blogs; ?></option>
                <option value="tags" selected="selected"><?php echo $text_tags; ?></option>
                <option value="all"><?php echo $text_all; ?></option>
                <?php } else { ?>
                <option value="blogs"><?php echo $text_blogs; ?></option>
                <option value="tags"><?php echo $text_tags; ?></option>
