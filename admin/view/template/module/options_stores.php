        ...
        <div class="tab-content ">
			...
			<div class="so-panel">
				...
				<div class="panel-container">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">
							<span data-toggle="tooltip" title="Upload image in path: catalog/ and write the name here">Image (Top panel):</span>
						</label>
						<div class="col-sm-9">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<ul class="nav nav-tabs" id="language-footer_socials_title">
									...
									<li class="<?php echo ($language['language_id'] == 1 ? 'active' : ''); ?>"><a href="#language-footer_socials_title<?php echo $language['language_id']; ?><?php echo $store["store_id"]; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php endforeach; ?>
								</ul>
								<div class="tab-content">
									<?php foreach ($languages as $language) : ?>
				...
				<div class="so-panel">
					...
					<div class="panel-container">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<ul class="nav nav-tabs" id="language-footerpayment_title">
									<?php foreach ($languages as $language) : ?>
									<li class="<?php echo ($language['language_id'] == 1 ? 'active' : ''); ?>"><a href="#language-footerpayment_title<?php echo $language['language_id']; ?><?php echo $store["store_id"]; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
									<?php endforeach; ?>
								</ul>
								<div class="tab-content">
									<?php foreach ($languages as $language) : ?>
									<div class="tab-pane <?php echo ($language['language_id'] == 1 ? 'active' : ''); ?>" id="language-footerpayment_title<?php echo $language['language_id']; ?><?php echo $store["store_id"]; ?>">
										<textarea name="soconfig_general_store[<?php echo $language['language_id']; ?>][<?php echo $store["store_id"]; ?>][footerpayment_html]" placeholder="Footer Social Block content" id="input-description-footerpayment<?php echo $language['language_id']; ?>-<?php echo $store['store_id']; ?>">
										<?php echo isset($soconfig_general_store[$language['language_id']][$store["store_id"]]['footerpayment_html']) ? $soconfig_general_store[$language['language_id']][$store["store_id"]]['footerpayment_html'] : ''; ?>
										</textarea>
									</div>
									<?php endforeach; ?>
								</div>
            ...
            <div id="tab-general-layout4-<?php echo $store['store_id']; ?>" class="tab-pane">
				...
				<div class="so-panel">
					...
					<div class="panel-container">
						...
						<ul class="nav nav-tabs" id="translation">
							<?php foreach ($languages as $language) : ?>
							<li class="<?php echo ($language['language_id'] == 1 ? 'active' : ''); ?>"><a href="#translation_countdown_<?php echo $language['language_id']; ?><?php echo $store["store_id"]; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
							<?php endforeach; ?>
						</ul>
						<div class="tab-content">
							<?php foreach ($languages as $language) : ?>
					...
					<div class="panel-container">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<ul class="nav nav-tabs" >
									<?php foreach ($devices as $subfix => $device) : ?>
									<li class="<?php echo ($subfix == 'md' ? 'active' : ''); ?>"><a href="#language-product_related_<?php echo $subfix ?><?php echo $store["store_id"]; ?>" data-toggle="tab"><?php echo $device ?></a></li>
									<?php endforeach; ?>
								</ul>
								<div class="tab-content">
									<?php foreach ($devices as $subfix => $device) : ?>
									<div class="tab-pane <?php echo ($subfix == 'md' ? 'active' : ''); ?>" id="language-product_related_<?php echo $subfix ?><?php echo $store["store_id"]; ?>">
