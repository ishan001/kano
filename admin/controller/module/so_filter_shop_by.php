...
class ControllerModuleSofiltershopby extends Controller {
	...
	public function index() {
		...
		// Get module id new 
		$moduleid_new= $this->model_module_so_filter_shop_by->getModuleId(); // Get module id
		$module_id = '';
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if($action == "save_edit") {
				$this->response->redirect($this->url->link('module/so_filter_shop_by', 'module_id='.$module_id.'&token=' . $this->session->data['token'], 'SSL'));
		...
		$manufactures = $this->model_module_so_filter_shop_by->getMenufacture();
		...
		$data['link'] = $this->url->link('module/so_filter_shop_by', 'token=' . $this->session->data['token'] . '', 'SSL');
