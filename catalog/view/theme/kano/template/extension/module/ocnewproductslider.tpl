<div class="new-product-slider special-button-owl">
    <div class="module-title">
        <h2 class="new-product__title">
            <?php
  ...
  $(document).ready(function () {
    $(".newproducts-slider").owlCarousel({
      ...
      items: <?php
        ...
        ?>,
      slideSpeed: <?php
        if ($config_slide['f_speed']) {
            echo
            $config_slide['f_speed'];
        } else {
            echo
            200;
        }
        ?>,
      navigation: <?php
        if ($config_slide['f_show_nextback']) {
            echo
            'true';
        } else {
            echo
