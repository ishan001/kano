					...
					<a class="lt-image" 
					   href="<?php echo $item['link'] ?>" target="<?php echo $item_link_target ?>"
						...
						<?php if($product_image_num ==2){?>
							<img src="<?php echo $item['thumb']?>" class="img-thumb1" alt="<?php echo $item['nameFull'] ?>">
							<img src="<?php echo $item['thumb2']?>" class="img-thumb2" alt="<?php echo $item['nameFull'] ?>">
						<?php }else{?>
							<img src="<?php echo $item['thumb']?>" alt="<?php echo $item['nameFull'] ?>">
						<?php }?>
					</a>
					<?php }?>
				</div>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($){
            var $tag_id = $('#<?php echo $tag_id; ?>'),
                ...
                _delay = <?php echo $product_delay; ?>,
				_duration = <?php echo $product_duration; ?>,
