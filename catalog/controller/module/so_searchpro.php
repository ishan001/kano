...
class ControllerModuleSosearchpro extends Controller {
	...
	public function index( $setting ) { 
		...
		if(version_compare(VERSION, '2.1.0.2', '>')) {
			return $this->load->view('module/so_searchpro/default.tpl',$this->data);
		} else {
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/so_searchpro/default.tpl')) {
				$template = $this->config->get('config_template') . '/template/module/so_searchpro/default.tpl';
			} else {
				$template = 'default/template/module/so_searchpro/default.tpl';
			}
